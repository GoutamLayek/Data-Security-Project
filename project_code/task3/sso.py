...
app.secret_key = "your-client-secret"  # make sure this matches with that's in client_secret.json
...
def callback():
    ...
    id_info = id_token.verify_oauth2_token(
        id_token=credentials._id_token, request=token_request, audience=app["CLIENT_ID"]
    )
